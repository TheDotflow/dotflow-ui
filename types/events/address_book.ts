...
export default class EventsClass {
	...
	public subscribeOnAddressBookCreatedEvent(callback : (event : EventTypes.AddressBookCreated) => void) {
	...
	public subscribeOnAddressBookRemovedEvent(callback : (event : EventTypes.AddressBookRemoved) => void) {
		const callbackWrapper = (args: any[], event: any) => {
			const _event: Record < string, any > = {};
	...
	public subscribeOnIdentityAddedEvent(callback : (event : EventTypes.IdentityAdded) => void) {
		const callbackWrapper = (args: any[], event: any) => {
			const _event: Record < string, any > = {};
	...
	public subscribeOnNickNameUpdatedEvent(callback : (event : EventTypes.NickNameUpdated) => void) {
		const callbackWrapper = (args: any[], event: any) => {
			const _event: Record < string, any > = {};
